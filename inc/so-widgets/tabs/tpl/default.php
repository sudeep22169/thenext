...
<div class="tabs">
    ...
    <?php   foreach ( $instance['tabs_repeater'] as $key=>$tabs ){  
        ...
        <li class="nav-item">
          <a class="nav-link <?php echo $active;?>" data-toggle="pill" href="#<?php echo esc_attr( $key );?>"><?php echo esc_attr( $tabs['title'] );   ?></a>
        </li>
    <?php } ?>
    </ul>
</div>
<div class="tab-content">
    <?php   foreach ( $instance['tabs_repeater'] as $keys=>$tabs ){ 
        ...
        <div class="tab-pane fade <?php echo esc_attr( $active );?>" id="<?php echo esc_attr( $keys );?>">
