	...
	<div class="container">
		<div class="row">
			...
			<div class="col-sm-12 col-md-3 text-xs-right">
				<a class="btn btn-lg btn-<?php echo esc_attr($instance['buttontype']);?>-only" href="<?php echo esc_url( $instance['get_quote_link'] ); ?>"><?php echo esc_attr( $instance['get_quote_text'] );?></a>
			</div>
		</div>
	</div>
</section>